...
$.post( '', { 'note' : note.val() })
  ...
  $('#release-decks-modal').on('show.bs.modal', function (e) {
  	$( "#release-decks-modal .modal-body" ).load('mytcg/cards/edit' + e.relatedTarget.dataset.deckStatus + '/' + e.relatedTarget.dataset.deckId, function(){
  	    // hide/unhide fields
